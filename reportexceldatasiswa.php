<?php  
session_start(); // mMmulai session
include('connect.php'); // Memasukan file koneksi2.php
...
$writer->save('Data Pendaftaran Siswa.xlsx'); // Menyimpan report file excel dengan nama file Report Data Siswa.xlsx
